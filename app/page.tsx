...
export default function Home(){
  ...
  return <main>
    ...
    <CategoryEdit id="gemstones" variant="mosaic" index="03" kicker="RAW & NATURAL" title="The Gemstone Edit" copy="Individual colour, organic variation and pieces designed to layer rather than match perfectly." category="Gemstone Jewellery" subcategories={[["All Gemstone Jewellery",CP.gemstone],["Earrings",CP.gemstone],["Pendants",CP.gemstone],["Charms",CP.gemstone],["Bracelets & Chains",CP.gemstone]]} image={`${A}/lifestyle/look-statement-gemstone.webp`} products={products.filter(p=>p.category==="Gemstone Jewellery")}/>
