  ...
  return <main>
    ...
    <section className="section category-section" id="collection">
      ...
      <div className="category-grid">
        ...
        <CategoryCard href={CP.diamond} title="Diamond Jewellery" copy="Modern lab-grown brilliance in clean, wearable settings." image={`${A}/drive/lab-1.webp`} video={`${A}/motion/diamond-showcase.mp4`}/>
