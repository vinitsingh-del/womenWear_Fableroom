  ...
  return <main>
    ...
    <section className="trust-and-proof" id="proof">
      <div className="trust-box" aria-label="Why FableRoom">
        <TrustStat image={`${A}/editorial/hero-women-fashion-lifestyle.webp`} end={14000} suffix="+" label="Happy homes"/>
        <TrustStat image={`${A}/drive/lab-1.webp`} end={6} prefix="£" suffix="M+" label="Total customer savings"/>
        <TrustStat image={`${A}/editorial/a-plus-jewellery.webp`} end={100} suffix="%" label="Responsibly sourced"/>
        <TrustStat image={`${A}/editorial/scarf-lifestyle.webp`} end={0} label="Middlemen markups"/>
      </div>
