  ...
  return <main>
    ...
    <section className="section category-section" id="collection">
      ...
      <div className="category-grid">
        ...
        <CategoryCard href={CP.gemstone} title="Gemstone Jewellery" copy="Natural colour, made for layering." image={`${A}/drive/gem-1.webp`} video={`${A}/motion/gemstone-showcase.mp4`}/>
